...
<!--        <div class="headline"><h3>{{experience.position}} - {{experience.company}}</h3></div>-->
...
<!--        <div class="headline">{{project.name}}</h3>-->
        <div class="headline"><h3>{{project.name}}</h3>
<!--        <div class="headline"><h3>{{project.name}}</h3></div>-->
...
export default getVueOptions(name);
...
#myselfpic {
  background-image: url('../../resume/id.jpeg');
  color: black;
}
#githubIcon {
  width: 25px;
